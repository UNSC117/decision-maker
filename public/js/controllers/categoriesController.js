(function() {
    ...
    angular
        ...
        .controller('categoriesCtrl', CateCtrl);
    function CateCtrl($scope, $log) {
        var tabs = [
        ...
        $scope.addTab = function(title) {
            tabs.push({title: title, content: "Empty", disabled: false});
        };
        ...
        $scope.save = function() {
            alert("You selected: " + $scope.category);
        };

        $scope.edit = function() {
            alert("Edit: " + $scope.category);
        }
    }
})();