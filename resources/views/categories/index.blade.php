            ...
            <md-input-container>
                ...
                <div class="editBtn" layout="row" layout-align="end center">
                    ...
                    @else
                        ...
                        <md-button ng-click="addCategory($event)" ng-disabled="playing" class="md-primary md-raised"
                                   layout
                                   layout-align="center center">New
                        </md-button>
                        <md-button ng-click="removeCategory($event)" ng-disabled="playing || !category"
                                   class="md-warn md-raised" layout
                                   layout-align="center center">remove
                        </md-button>
                    @endif
